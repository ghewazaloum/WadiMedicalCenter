...
const add_doctor=(e)=>{
  e.preventDefault();
  console.log(DoctorName,DoctorSpecialization,DoctorDescription,DoctorSection,saturday,sunday)
  let formdata=new FormData();
  formdata.append('name',DoctorName);
  formdata.append('therapistImage',DoctorImagetosend);
  ...
  formdata.append('endHoursIn',endHoursIn);
   if(DoctorName!==''&&DoctorSection!==null&&startHoursIn!=='00:00'&&endHoursIn!=='00:00'&&(saturday!=='0'||sunday!=='0'||monday!=='0'||tuesday!=='0'||wednesday!=='0'||thursday!=='0'||friday!=='0')){
    if(headers.Authorization!=='Token undefined'){
    axios.post(`${BASE_URL}appmanager/add_therapist`,formdata,{headers}).then((res)=>{
    ...
    <div className="AddTherapist">
       ...
       <tr key={i}>
        ...
        <TableHeading>Therapists</TableHeading>
          <button className='NotACtivatedaddTherapist'>
            <a href=''>
             Add
            </a>
            </button>
      ...
      <RightSideBar>
        <LeftSideBarHeading>New Therapist</LeftSideBarHeading>
