...
const navigateToEditTherapist=(doctorName)=>(e)=>{
 ...
 navigate('/EditTherapist', { replace: true, state: {doctorName:doctorName,DoctorAndTherapist:DoctorAndTherapist}})
  ...
  return (
    ...
    <div className="DoctorsAppManager">
         <LeftSideBar>
         <LeftSideBarHeading>
       ...
       <tr key={i}>
            ...
            <button className='appmanagerEditButton'>
              <a href=''onClick={navigateToEditDoctor(val.Name)}>
                Edit
                </a>
                </button>
            </td>
        ...
        <TableHeading>Therapists</TableHeading>
          <button className='addTherapist'>
            <a href=''onClick={navigateToAddTherapist} >
             Add
            </a>
            </button>
...
export default DoctorsAppManager



{/* <svg className='TrueIcon' width="13" height="13" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path onClick={handleTrueIcon} className='emptyTrueIcon' d="M9.47087 15.9935L9.47091 15.9935L16.9719 8.49253C17.5195 7.94493 17.5195 7.05705 16.9719 6.50945L16.0495 5.58708C15.5019 5.03936 14.614 5.03942 14.0663 5.58704L8.47936 11.174L6.15365 8.84829C5.60603 8.30066 4.71818 8.30072 4.17058 8.84824L4.17053 8.84829L3.24812 9.7707C2.70052 10.3183 2.70052 11.2062 3.24812 11.7538L7.4878 15.9935C8.03543 16.5411 8.92323 16.5411 9.47087 15.9935ZM19.47 10.11C19.47 15.2794 15.2794 19.47 10.11 19.47C4.9406 19.47 0.75 15.2794 0.75 10.11C0.75 4.9406 4.9406 0.75 10.11 0.75C15.2794 0.75 19.47 4.9406 19.47 10.11Z" fill="#F5F5F5" stroke="#291B27" strokeWidth="1.5"/>
            </svg>
